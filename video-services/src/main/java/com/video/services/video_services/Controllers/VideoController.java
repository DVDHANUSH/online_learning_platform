package com.video.services.video_services.Controllers;
import com.video.services.video_services.dto.VideoDto;
import com.video.services.video_services.dto.VideoUploadResponse;
import com.video.services.video_services.services.VideoService;
import com.video.services.video_services.services.VideoUploadService;
...
public class VideoController {
    ...
    // return type - resourse - it might be video, images etc.,
    // in the params, we are passing a "RequestHeader" called "Range", it is optional, it might or not pass.
    // based on this we can know, if we have to load the entire video file or partial file specified in the range.
